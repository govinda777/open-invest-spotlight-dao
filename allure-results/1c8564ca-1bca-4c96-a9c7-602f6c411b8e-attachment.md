...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:70:3
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Frequently Asked Questions' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:74:85
```
