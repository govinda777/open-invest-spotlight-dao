...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:49:3
...
Call log:
  - waiting for getByRole('button', { name: 'Learn about all user types' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:51:76
```
