...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:66:3
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Back to Journeys' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:70:72
```
