...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:111:3
...
Call log:
  - waiting for getByRole('button', { name: 'Complete Step' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:119:63
```
