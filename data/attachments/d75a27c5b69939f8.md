...
- Name: basic test
- Location: /home/runner/work/open-invest-spotlight-dao/open-invest-spotlight-dao/tests/e2e/example.spec.ts:3:1
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /home/runner/work/open-invest-spotlight-dao/open-invest-spotlight-dao/tests/e2e/example.spec.ts:5:22
```
...
```ts
  ...
  4 |   await page.goto('/');
> 5 |   await expect(page).toHaveTitle(/Open Invest Spotlight DAO/);
    |                      ^ Error: Timed out 10000ms waiting for expect(locator).toHaveTitle(expected)
  6 | }); 
```
