...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:124:3
...
Call log:
  - waiting for locator('a').filter({ hasText: 'Begin Investor Journey' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:139:24
```
