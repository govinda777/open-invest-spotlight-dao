...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:110:3
...
Call log:
  - waiting for getByText('Investor')
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/onboarding.spec.ts:119:11
```
...
```ts
   ...
   4 |   // Wait for the main content to be visible
   5 |   await page.waitForSelector('main', { timeout: 5000 });
   6 | };
   7 |
  ...
  34 |     await page.waitForSelector('main');
  35 |   }
  36 | };
  37 |
...
> 40 |   await page.getByText(userType).click();
  ...
  44 |   
  45 |   // Wait for main content to be visible
  46 |   await page.waitForSelector('main');
  47 | }; 
```