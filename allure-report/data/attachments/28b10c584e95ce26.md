...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:71:3
...
Locator: getByRole('heading', { name: 'User Types' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 3000ms
  - waiting for getByRole('heading', { name: 'User Types' })

    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:75:69
```
...
>  75 |     await expect(page.getByRole('heading', { name: 'User Types' })).toBeVisible({ timeout: 3000 });
  ...
  160 |     await expect(page.getByText('Welcome to Community Member Journey')).toBeVisible({ timeout: 3000 });
  161 |   });
  162 | }); 
```