...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/wallet.test.ts:12:3
...
Call log:
  - waiting for getByRole('button', { name: 'Connect Wallet' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/wallet.test.ts:14:25
```
