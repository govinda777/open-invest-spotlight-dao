...
- Location: /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:150:3
...
Call log:
  - waiting for getByRole('button', { name: 'Begin Investor Journey' })
    ...
    at /Users/gosouza/projetos-p/open-invest-spotlight-dao/tests/e2e/journeys.spec.ts:157:72
```
